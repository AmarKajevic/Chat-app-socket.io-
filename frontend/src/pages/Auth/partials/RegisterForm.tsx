...
import {Loader2,  LockKeyhole, Mail, User, User2 } from "lucide-react"
    ...
    <>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
                ...
                <div className="relative mb-2">
                    <User2 className="absolute inset-y-0 left-3 size-5 text-gray-400 top-1/2 -translate-y-1/2"/>
             ...
             <div>
                ...
                <div className="relative mb-2">
                    <Mail type="email" className="absolute inset-y-0 left-3 size-5 text-gray-400 top-1/2 -translate-y-1/2"/>
                    <input {...register('email')}
                        className="text-sm w-full pl-10 pr-3 py-3  border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary "
                        placeholder="John99@gmail.com"
                    />
                </div>
             ...
             <div>
                ...
                <div className="relative mb-2">
                    <LockKeyhole className="absolute inset-y-0 left-3 size-5 text-gray-400 top-1/2 -translate-y-1/2"/>
