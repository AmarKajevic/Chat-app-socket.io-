...
const ConversationItem = ({conversationId, friend, unreadCounts, lastMessage}:Conversations) => {
  ...
  return (
    ...
    >
        <div className='relative '>
            <img src="https://i.pravatar.cc/150?u=123" alt='User' className='size-10 rounded-full object-cover'/> 
            <div className={`
        ...
        <div className='flex-1 min-w-0 '>
            ...
            <div className='flex items-center'>
                ...
                {user && unreadCounts[user.id] > 0 && (
                    <div className='bg-sky-500 text-xs text-white rounded-full size-5 flex items-center justify-center shrink-0'>
